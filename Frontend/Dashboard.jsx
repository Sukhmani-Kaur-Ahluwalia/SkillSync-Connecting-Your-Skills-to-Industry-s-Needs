...
function Dashboard({ name, email, interest, skills, studentId, onEdit, onLogout }) {
  ...
  return (
    <div style={{ backgroundColor: '#3c88cfff', minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', fontFamily: 'sans-serif', padding: '20px' }}>
      <div style={{ backgroundColor: '#dbf3ff', padding: '40px', borderRadius: '15px', boxShadow: '0 10px 25px rgba(0,0,0,0.1)', width: '100%', maxWidth: '700px', position: 'relative' }}>
        {onLogout && (
          <button
            onClick={onLogout}
            style={{
